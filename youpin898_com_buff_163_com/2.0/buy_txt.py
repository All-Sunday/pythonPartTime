...
def query_youyou_key(commodity_dict, uid):
    api_url = 'https://api.youpin898.com/api/youpin/detect/detection/2/' + uid + '/' + str(
        commodity_dict['Id']) + '/app'
...
def query_youyou_order(commodity_dict, key, mode, uid):
    headers_app = {'Host': 'api.youpin898.com',
                   'Connection': 'close',
                   'AppType': '7',
