...
def query_qcc_res(wk, ws1, ws2, source_path, driver, target_cities):
    ...
    for province_index in range(14, provinces_length):
        # 无需取消勾选  已经操作过
        # if province_index != 0:
        ...
        #     '//div[@class="filter-area"][1]/div[4]/div[2]/div/div/div/div/div[2]/div/ul').tag_name)
        time.sleep(0.8)
        # try:
        #     print(driver.find_element_by_xpath(
        #         '//div[@class="filter-area"][1]/div[4]/div[2]/div/div/div/div/div[2]/div/ul').tag_name)
        ...
        #         'body > div:nth-child(2) > div.app-search-advance > div.container.m-t > div > div.page-col-lg > div > div.npanel-body > div:nth-child(4) > div:nth-child(4) > div.pills-after > div > div > div > div > div:nth-child(2) > div > ul').tag_name)
        # time.sleep(1000)
